...
% Last Modified by GUIDE v2.5 19-Jun-2017 16:15:20
...
situation=3;
[FileName,PathName,FilterIndex] = uigetfile('*.mp3;*.wav;*.wmv','ÇëÑ¡ÔñÒôÀÖ');
...
% --- Executes during object creation, after setting all properties.
function mainback_CreateFcn(hObject, eventdata, handles)
% hObject    handle to mainback (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
imshow('Äñ³²ÊÖ»æ.jpg');
